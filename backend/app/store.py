...
class IncidentStore:
    ...
    def _rows(self, where: str = "", params: tuple = (),
        ...
        # Real-world Bengaluru GPS mapping for each grid zone (HSR & ORR corridor)
        zone_gps = {
            "Z-01": (12.9116, 77.6436), # HSR Layout Sector 4
            "Z-02": (12.9135, 77.6412), # HSR 19th Main Road
            "Z-03": (12.9160, 77.6375), # Outer Ring Road Slip Road
            "Z-04": (12.9185, 77.6358), # Outer Ring Road (Trunk)
            "Z-05": (12.9215, 77.6342), # Outer Ring Road (Trunk)
            "Z-06": (12.9250, 77.6300), # Sarjapur Road Underpass
            "Z-07": (12.9295, 77.6258), # Hosur Road Connector
            "Z-08": (12.9325, 77.6215), # Hosur Road Flyover
            "Z-09": (12.9355, 77.6185), # Hosur Road Flyover
            "Z-10": (12.9380, 77.6150), # Madiwala Circle
            "Z-11": (12.9090, 77.6450), # HSR Layout Sector 3
            "Z-12": (12.9050, 77.6480), # HSR Layout Sector 2
        }
        ...
        for r in cur.fetchall():
            ...
            z = d.get("zone")
            if z in zone_gps:
                d["latitude"], d["longitude"] = zone_gps[z]
            else:
